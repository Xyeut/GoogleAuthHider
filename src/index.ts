...
function hideEmails() {
	...
	const filter = (email: string) => {
		...
		if (credentialArray.length > 2) credentialArray = [...credentialArray.slice(0, 1), credentialArray.slice(1).join("")];
